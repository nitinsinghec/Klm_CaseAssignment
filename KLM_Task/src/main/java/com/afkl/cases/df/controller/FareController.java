...
public class FareController {
	...
	public ResponseEntity<FareVO> getFareByAirportCode(@PathVariable("originCode") String originCode,@PathVariable("destinationCode") String destinationCode,
			@RequestParam(value = "currency", required = false, defaultValue = "EUR") String currency)  throws Exception{
		...
		String resourceUrl =appProperties.getBaseRestApiUrl()+"fares/"+originCode+"/"+destinationCode+"?currency="+currency+"&access_token="+lOAuthTokenVO.getAccess_token();
