...
public class AirportController {
	...
	public ResponseEntity<EmbeddedWrapperVO> getAirportList(HttpServletRequest request,
		...
		String resourceUrl = appProperties.getBaseRestApiUrl() + "airports?lang=" + lang + "&access_token="
				+ lOAuthTokenVO.getAccess_token();
		ResponseEntity<EmbeddedWrapperVO> responseEntity = lRestTemplate.getForEntity(resourceUrl,
				EmbeddedWrapperVO.class);
	...
	public ResponseEntity<EmbeddedDetailWrapperVO> getAirportDetailList(HttpServletRequest request,
		...
		String resourceUrl = appProperties.getBaseRestApiUrl() + "airports?lang=" + lang + "&access_token="
				+ lOAuthTokenVO.getAccess_token();
		ResponseEntity<EmbeddedDetailWrapperVO> responseEntity = lRestTemplate.getForEntity(resourceUrl,
				EmbeddedDetailWrapperVO.class);
	...
	public ResponseEntity<AirportDetailVO> getAirportById(@PathVariable("code") String code,
		...
		OAuthTokenVO lOAuthTokenVO = authenticationClient.getOAuthToken(appProperties.getBaseRestApiUrl());
		RestTemplate lRestTemplate = new RestTemplate();
		String resourceUrl = appProperties.getBaseRestApiUrl() + "airports/" + code + "?lang=" + lang + "&access_token="
				+ lOAuthTokenVO.getAccess_token();
